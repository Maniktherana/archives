          ...
          {showMore
            ? stats.map((item) => (
                <div key={item.id} className="group relative">
                  <div className="flex flex-col justify-between w-full min-h-[135px] p-5 border border-solid border-gray-200 bg-gray-100 aspect-w-1 aspect-h-1 rounded-md overflow-hidden group-hover:opacity-75 lg:aspect-none">
